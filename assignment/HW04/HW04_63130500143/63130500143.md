...
ตัวอย่างเราอยากเลือกดูข้อมูลในเเถวที่ 5 ใน table superstore เราสามารถใช้คำสั่ง slice ใน #1 หรือถ้าอยากดูหลายๆ เเถวด้วยก็สามารถใช้เครื่องหมาย `,` ในการหาได้ดังในบรรทัดที่ #2
...
หรือถ้าเราอยากดูเเถวที่ 5 ถึง 9 ก็สามารถทำได้โดยใช้เตรื่องหมาย `:` ดังนี้
