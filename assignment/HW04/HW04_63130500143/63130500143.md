...
- Function `mutate()` from package [dplyr](https://dplyr.tidyverse.org/articles/dplyr.html#add-new-columns-with-mutate-)). it’s often useful to add new columns that are functions of existing columns.
