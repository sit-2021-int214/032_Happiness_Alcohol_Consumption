...
- Function `summerise()` from package [dplyr](https://dplyr.tidyverse.org/articles/dplyr.html#summarise-values-with-summarise-)). It collapses a data frame to a single row.
