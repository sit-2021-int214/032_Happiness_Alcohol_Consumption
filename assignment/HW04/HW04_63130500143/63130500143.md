...
ตัวอย่างเราอยากเลือกดูข้อมูลในเเถวที่ 5 ใน table superstore เราสามารถใช้คำสั่ง slice ได้ดังใน `#1` หรือถ้าอยากดูหลายๆ เเถวด้วยก็สามารถใช้เครื่องหมาย `,` ในการหาได้ดังในบรรทัดที่ `#2`
