...
- Function `select()` from package [dplyr](https://dplyr.tidyverse.org/articles/dplyr.html#select-columns-with-select)). ใช้สําหรับเลือก column ที่ต้องการเเสดง
 - วิธีการใช้ > เลือก column ที่ต้องการเเสดงใส่ใน () ดังตัวอย่าง
